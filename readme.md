...
### A Full-Stack Deepfake Detection Application developed using FastAPI, Tensorflow, OpenCV, React.js and Tailwind CSS
...
```
git clone https://github.com/apoorvcurry21/deepfake-detection.git
